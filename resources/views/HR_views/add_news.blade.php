@include('HR_views.navigation_header')
		...
		<form role="form" class="form-horizontal" method="POST">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<div class="input-group in-grp1">							
						<textarea rows="10" class="form-control1" placeholder="News Description" name="news_description" required></textarea>
			...
			<div class="form-group">
				<div class="col-md-8">
					<div class="input-group in-grp1">							
						{!! Form::token() !!}
						<input type="submit" class="btn btn-lg btn-success form-control1" name="addNews" value="Add News">
					</div>
			<div class="clearfix"> </div>
			</div>
