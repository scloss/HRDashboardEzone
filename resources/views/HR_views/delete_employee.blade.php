...
$(document).ready(function(){
    ...
    $( "#datepicker" ).datepicker();
		...
		<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Delete an Employee</h3>
			<div class="panel-body1">
					   
		<form role="form" class="form-horizontal" method="POST" action="{{ url('confirm_employee_delete') }}">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<div class="input-group in-grp1">							
						...
						<input type="text" class="form-control1" name="joining_date" value="{{$joiningDate}}" readonly>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<div class="input-group in-grp1">							
						<input type="text" id="datepicker" class="form-control1" name="leaving_date" required>
			...
			<div class="form-group">
				<div class="col-md-8">
					<div class="input-group in-grp1">							
						...
						<input type="submit" class="btn btn-lg btn-success form-control1" name="deleteEmp" value="Delete Employee" style="background-color:#C40401; color:white">
					</div>
			<div class="clearfix"> </div>
			</div>
